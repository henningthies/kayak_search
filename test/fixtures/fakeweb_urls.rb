...
module FakewebUrls
  ...
  SEARCHID = 'http://api.kayak.com/s/apisearch?basicmode=true&oneway=y&origin=HAM&destination=LCY&destcode=&depart_date=04-02-2010&depart_time=a&travelers=1&cabin=e&action=doflights&apimode=1&_sid_=27-MZEBH9pIH3djH0xMRDLl&nearbyO=1&nearbyD=1'
